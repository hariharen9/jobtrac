  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-8">Last updated: January 22, 2026</p>
        ...
        <div className="space-y-8 text-slate-600 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">2. Data We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">3. How We Use Your Data</h2>
            <p className="mb-2">Your data is used solely to provide the functionality of the JobTrac application:</p>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">4. Data Storage and Security</h2>
            <p>
          ...
          <section>
            ...
            <p className="mb-2">Since this is your data, you have the right to:</p>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">6. Third-Party Services</h2>
            <p className="mb-2">JobTrac uses the following third-party services:</p>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">7. Browser Extension</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">9. Contact Me</h2>
            <p className="mb-2">If you have any questions about this Privacy Policy, please contact me at:</p>
            <p>
        ...
        <div className="mt-10 pt-6 border-t border-slate-200 dark:border-slate-700">
          <Link
            to="/"
            className="inline-block px-6 py-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-lg hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors"
          >
            Back to Home
          </Link>
        </div>
