...
const CompanyForm: React.FC<CompanyFormProps> = ({ onSubmit, onCancel, initialData, loading = false }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Company Name *</label>
        <input
          type="text"
          required
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">What They Do *</label>
        <textarea
          required
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Company Values</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Why I Want to Work Here *</label>
        <textarea
          required
          value={formData.why}
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Questions to Ask Them *</label>
        <textarea
          required
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Recent News/Updates</label>
        <textarea
          value={formData.news}
