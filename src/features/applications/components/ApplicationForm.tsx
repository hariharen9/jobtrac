  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Role *</label>
          <input
            type="text"
            required
            value={formData.role}
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Job Link</label>
          <input
            type="url"
            value={formData.link}
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Date Applied</label>
          <input
            type="date"
            value={formData.date}
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Recruiter Email</label>
          <input
            type="email"
