  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Date *</label>
          <input
            type="date"
            required
            value={formData.date}
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Topic *</label>
          <input
            type="text"
            required
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Problems/Resources URL</label>
          <input
            type="url"
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Time Spent (hours) *</label>
          <input
            type="number"
            required
            min="0"
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Confidence Level (1-5) *</label>
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1"
            />
            <span className="text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text w-8">{formData.confidence}/5</span>
          </div>
        </div>
      </div>
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-dark-text amoled:text-amoled-text mb-1">Key Takeaways *</label>
        <textarea
          required
